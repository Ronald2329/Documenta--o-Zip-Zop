...
public class SendMessageLocation {
    ...
    public static void main(String[] args) {
        ...
        String latitude = "-6.2";
        String longitude = "106.8";
        String description = "Jakarta";
        ...
        try {
            ...
            String jsonInputString = String.format(
                "{\"chatId\": \"%s\", \"contentType\": \"Location\", \"content\": {\"latitude\": %s, \"longitude\": %s, \"description\": \"%s\"}}",
                chatId, latitude, longitude, description
            );
