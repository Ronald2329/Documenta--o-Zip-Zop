...
public class SendMessageMedia {
    ...
    public static void main(String[] args) {
        ...
        String data = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII=";
        ...
        try {
            ...
            String jsonInputString = String.format(
                "{\"chatId\": \"%s\", \"contentType\": \"MessageMedia\", \"content\": {\"mimetype\": \"%s\", \"data\": \"%s\", \"filename\": \"%s\"}}",
                chatId, mimetype, data, filename
            );
